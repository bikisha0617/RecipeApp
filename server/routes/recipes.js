...
function getImageUrl(image) {
    ...
    return (
        ...
        encodeURIComponent(path.basename(cleanImage))
    );
}
    ...
    async function (req, res) {
        ...
        try {
            ...
            const ingredientArray =
                cleanStringArray(
                    parseArray(req.body.ingredients)
                );

            const instructionArray =
                cleanStringArray(
                    parseArray(req.body.instructions)
                );
    ...
    async function (req, res) {
        ...
        try {
            ...
            recipe.calories =
                Math.max(
                    0,
                    Number(req.body.calories) || 0
                );

            recipe.protein =
                Math.max(
                    0,
                    Number(req.body.protein) || 0
                );
