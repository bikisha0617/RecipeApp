...
router.get("/me",authenticateToken,requireUser,async function (req,res) {
    try {
...
router.get("/:id",authenticateToken,requireUser,async function (req,res) {
    try {
...
router.put("/:id",authenticateToken,requireUser,async function (req,res) {
    try {
...
router.delete("/:id",authenticateToken,requireUser,async function (req,res) {
