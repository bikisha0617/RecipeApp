document.addEventListener("DOMContentLoaded", function () {
    ...
    const recipeGrid =
        document.getElementById("profileRecipeGrid");
    ...
    function displayRecipes(
        ...
        recipes.forEach(function (recipe) {
            ...
            container.innerHTML +=
                "<a href='recipe.html?id=" +
                recipeId +
                "' class='profile-card-small'>" +
    ...
    async function loadProfile() {
        ...
        try {
             ...
             * a separate saved-recipes API.
             *
             * Favourites are the saved recipes
